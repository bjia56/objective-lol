				...
				PublicFunctions: map[string]*environment.Function{
					...
					"FIND": {
						...
						Documentation: []string{
							...
							"I HAS A VARIABLE DIR TEH CABINET ITZ NEW CABINET WIT \"documents\"",
							"I HAS A VARIABLE TXTFILES TEH BUKKIT ITZ DIR DO FIND WIT \"*.txt\"",
							"IM OUTTA UR TXTFILES NERFIN FILENAME",
					...
					"PATH": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"@note Combine with FILE.SEP to build full file paths",
								"@see FILE.SEP",
								"@category directory-properties",
							},
						},
		...
		fileVariables = map[string]*environment.Variable{
			"SEP": {
				...
				Documentation: []string{
					...
					"I HAS A VARIABLE FULLPATH TEH STRIN ITZ DIR MOAR FILE.SEP MOAR FILENAME",
					...
					"I HAS A VARIABLE PATH TEH STRIN ITZ \"home\" MOAR FILE.SEP MOAR \"user\" MOAR FILE.SEP MOAR \"data\"",
					"I HAS A VARIABLE DIR TEH CABINET ITZ NEW CABINET WIT PATH",
					"DIR DO CREATE",
					"@example Parse directory paths",
					"I HAS A VARIABLE PARTS TEH BUKKIT ITZ FULLPATH DO SPLIT WIT FILE.SEP",
					"IM OUTTA UR PARTS NERFIN PART",
