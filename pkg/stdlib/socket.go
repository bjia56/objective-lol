		...
		socketClasses = map[string]*environment.Class{
			"SOKKIT": {
				...
				Documentation: []string{
					...
					"SERVER HAZ HOST ITZ \"0.0.0.0\"",
					"SERVER HAZ PORT ITZ 8080",
					"SERVER HAZ PROTOCOL ITZ \"TCP\"",
					"SERVER DO BIND",
					"SERVER DO LISTEN",
					"@example TCP client connection",
					"I HAS A VARIABLE CLIENT TEH SOKKIT ITZ NEW SOKKIT",
					"CLIENT HAZ HOST ITZ \"127.0.0.1\"",
					"CLIENT HAZ PORT ITZ 8080",
					...
					"UDP_SOCK HAZ PROTOCOL ITZ \"UDP\"",
					"UDP_SOCK HAZ PORT ITZ 9999",
					"UDP_SOCK DO BIND",
				...
				PublicFunctions: map[string]*environment.Function{
					...
					"SOKKIT": {
						...
						Documentation: []string{
							...
							"I HAS A VARIABLE SERVER TEH SOKKIT ITZ NEW SOKKIT",
							"SERVER HAZ PROTOCOL ITZ \"TCP\"",
							"SERVER HAZ HOST ITZ \"0.0.0.0\" BTW Listen on all interfaces",
							"SERVER HAZ PORT ITZ 3000",
							"SERVER HAZ TIMEOUT ITZ 60 BTW 60 second timeout",
					...
					"LISTEN": {
						...
						Documentation: []string{
							...
							"    SAYZ WIT CLIENT HAZ REMOTE_HOST",
					...
					"ACCEPT": {
						...
						Documentation: []string{
							...
							"    SAYZ WIT CLIENT HAZ REMOTE_HOST",
							"    SAYZ WIT \":\"",
							"    SAYZ WIT CLIENT HAZ REMOTE_PORT",
					...
					"CONNECT": {
						...
						Documentation: []string{
							...
							"CLIENT HAZ HOST ITZ \"127.0.0.1\"",
							"CLIENT HAZ PORT ITZ 8080",
							"CLIENT HAZ TIMEOUT ITZ 10 BTW 10 second timeout",
							"I HAS A VARIABLE CONN TEH WIRE ITZ CLIENT DO CONNECT",
							"SAYZ WIT \"Connected to server!\"",
							"@example HTTP client example",
							"CLIENT HAZ HOST ITZ \"httpbin.org\"",
							"CLIENT HAZ PORT ITZ 80",
							"I HAS A VARIABLE CONN TEH WIRE ITZ CLIENT DO CONNECT",
					...
					"SEND_TO": {
						...
						Documentation: []string{
							...
							"UDP_CLIENT HAZ PROTOCOL ITZ \"UDP\"",
							"UDP_CLIENT HAZ PORT ITZ 0 BTW Use any available port",
							"UDP_CLIENT DO BIND",
					...
					"RECEIVE_FROM": {
						...
						Documentation: []string{
							...
							"UDP_SERVER HAZ PROTOCOL ITZ \"UDP\"",
							"UDP_SERVER HAZ PORT ITZ 9999",
							"UDP_SERVER DO BIND",
					...
					"HOST": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"I HAS A VARIABLE SOCK TEH SOKKIT ITZ NEW SOKKIT",
								"SOCK HAZ HOST ITZ \"192.168.1.100\"",
								"SAYZ WIT \"Connecting to \"",
								"SAYZ WIT SOCK HAZ HOST",
								"@example Set hostname",
								"SOCK HAZ HOST ITZ \"example.com\"",
								"@example Server listening on all interfaces",
								"I HAS A VARIABLE SERVER TEH SOKKIT ITZ NEW SOKKIT",
								"SERVER HAZ HOST ITZ \"0.0.0.0\" BTW Listen on all network interfaces",
								"SERVER HAZ PORT ITZ 8080",
								"SERVER DO BIND",
								"@example Localhost connections only",
								"SERVER HAZ HOST ITZ \"127.0.0.1\" BTW Local connections only",
					...
					"PORT": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"I HAS A VARIABLE SERVER TEH SOKKIT ITZ NEW SOKKIT",
								"SERVER HAZ PORT ITZ 80 BTW HTTP default port",
								"@example Set custom port",
								"SERVER HAZ PORT ITZ 3000",
								"@example Use ephemeral port (system assigns)",
								"I HAS A VARIABLE CLIENT TEH SOKKIT ITZ NEW SOKKIT",
								"CLIENT HAZ PORT ITZ 0 BTW System will assign available port",
								"CLIENT DO BIND",
								"@example Common port numbers",
								"BTW SERVER HAZ PORT ITZ 21    BTW FTP",
								"BTW SERVER HAZ PORT ITZ 22    BTW SSH",
								"BTW SERVER HAZ PORT ITZ 80    BTW HTTP",
								"BTW SERVER HAZ PORT ITZ 443   BTW HTTPS",
								"BTW SERVER HAZ PORT ITZ 993   BTW IMAPS",
					...
					"TIMEOUT": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"I HAS A VARIABLE CLIENT TEH SOKKIT ITZ NEW SOKKIT",
								"CLIENT HAZ HOST ITZ \"slow-server.com\"",
								"CLIENT HAZ TIMEOUT ITZ 5 BTW 5 second timeout",
								"MAYB",
								"    I HAS A VARIABLE CONN TEH WIRE ITZ CLIENT DO CONNECT",
								...
								"CLIENT HAZ TIMEOUT ITZ 120 BTW 2 minute timeout",
								"@example Disable timeout (wait indefinitely)",
								"CLIENT HAZ TIMEOUT ITZ 0 BTW No timeout",
								"@example Check current timeout",
								"SAYZ WIT \"Connection timeout: \"",
								"SAYZ WIT CLIENT HAZ TIMEOUT",
								"SAYZ WIT \" seconds\"",
			...
			"WIRE": {
				...
				Documentation: []string{
					...
					"SAYZ WIT \"Client connected from \"",
					"SAYZ WIT CLIENT_CONN HAZ REMOTE_HOST",
				...
				PublicFunctions: map[string]*environment.Function{
					...
					"SEND": {
						...
						Documentation: []string{
							...
							"CONN DO SEND WIT JSON_DATA HAZ SIZ",
							"CONN DO SEND WIT \"\\r\\n\\r\\n\"",
					...
					"RECEIVE": {
						...
						Documentation: []string{
							...
							"IM OUTTA UR LOOP WHILE NOT (BUFFER ENDS WIT \"END\")",
					...
					"REMOTE_HOST": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"SAYZ WIT CLIENT HAZ REMOTE_HOST",
								"SAYZ WIT \" -> \"",
								"SAYZ WIT CLIENT HAZ LOCAL_HOST",
								"SAYZ WIT \":\"",
								"SAYZ WIT CLIENT HAZ LOCAL_PORT",
								"@example Access control by IP",
								"IZ (CLIENT HAZ REMOTE_HOST) SAEM AS \"127.0.0.1\"?",
					...
					"REMOTE_PORT": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"IZ (CLIENT HAZ REMOTE_PORT) BIGGR DAN 1024?",
					...
					"LOCAL_HOST": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"IZ (CLIENT HAZ LOCAL_HOST) SAEM AS \"127.0.0.1\"?",
								"    SAYZ WIT \"Local loopback connection\"",
								"NOPE IZ (CLIENT HAZ LOCAL_HOST) SAEM AS \"0.0.0.0\"?",
					...
					"LOCAL_PORT": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"I HAS A VARIABLE PORT TEH INTEGR ITZ CLIENT HAZ LOCAL_PORT",
								"IZ PORT SAEM AS 80?",
					...
					"IS_CONNECTED": {
						Variable: environment.Variable{
							...
							Documentation: []string{
								...
								"IM OUTTA UR LOOP WHILE (CONN HAZ IS_CONNECTED)",
