					...
					"READ": {
						...
						NativeImpl: func(ctx interface{}, this *environment.ObjectInstance, args []environment.Value) (environment.Value, error) {
							...
							if err != nil {
								if err == io.EOF {
									pipeData.IsEOF = true
									updatePipeStatus(this, pipeData)
								} else {
				...
				PublicFunctions: map[string]*environment.Function{
					...
					"MINION": {
						...
						NativeImpl: func(ctx interface{}, this *environment.ObjectInstance, args []environment.Value) (environment.Value, error) {
							...
							this.Variables["CMDLINE"] = &environment.Variable{
								Name:     "CMDLINE",
								Type:     "BUKKIT",
								Value:    cmdline,
								IsLocked: true,
							...
							this.Variables["RUNNING"] = &environment.Variable{
								Name:     "RUNNING",
								Type:     "BOOL",
								Value:    environment.NO,
								IsLocked: true,
							...
							this.Variables["FINISHED"] = &environment.Variable{
								Name:     "FINISHED",
								Type:     "BOOL",
								Value:    environment.NO,
								IsLocked: true,
							...
							this.Variables["EXIT_CODE"] = &environment.Variable{
								Name:     "EXIT_CODE",
								Type:     "INTEGR",
							...
							this.Variables["PID"] = &environment.Variable{
								Name:     "PID",
								Type:     "INTEGR",
							...
							updateMinionStatus(this, minionData)
					...
					"START": {
						...
						NativeImpl: func(ctx interface{}, this *environment.ObjectInstance, args []environment.Value) (environment.Value, error) {
							...
							// Set PIPE variables
							this.Variables["STDIN"] = &environment.Variable{
								Name:     "STDIN",
								Type:     "PIPE",
								Value:    stdinPipe,
								IsLocked: true,
							...
							this.Variables["STDOUT"] = &environment.Variable{
								Name:     "STDOUT",
								Type:     "PIPE",
								Value:    stdoutPipe,
								IsLocked: true,
							...
							this.Variables["STDERR"] = &environment.Variable{
								Name:     "STDERR",
								Type:     "PIPE",
								Value:    stderrPipe,
								IsLocked: true,
